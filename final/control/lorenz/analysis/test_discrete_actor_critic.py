...
def watch_agent(num_episodes, num_steps_per_episode, specified_episode):
    ...
    print(f"Mean of total actor critic costs per episode over {num_episodes} episode(s): {actor_critic_costs_per_episode.mean()}")
    print(f"Standard deviation of total actor critic costs per episode over {num_episodes} episode(s): {actor_critic_costs_per_episode.std()}\n")
    ...
    print(f"Final actor critic state of episode #{specified_episode}: {actor_critic_states[specified_episode, -1]}\n")
    ...
    print(f"Difference between final actor critic state of episode #{specified_episode} and reference state: {np.abs(actor_critic_states[specified_episode, -1] - reference_point[:, 0])}")
    print(f"Norm between final actor critic state of episode #{specified_episode} and reference state: {np.linalg.norm(actor_critic_states[specified_episode, -1] - reference_point[:, 0])}\n")
