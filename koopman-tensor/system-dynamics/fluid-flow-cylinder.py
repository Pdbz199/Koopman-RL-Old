...
for episode in range(num_episodes):
    ...
    for step in range(num_steps_per_episode):
        ...
        x = true_x_prime
print(f"Average norm per episode over {num_episodes} episodes:", np.mean(np.sum(training_norms, axis=0)))
...
for episode in range(num_episodes):
    ...
    for step in range(num_steps_per_episode):
        ...
        x = true_x_prime
print(f"Average norm per episode over {num_episodes} episodes:", np.mean(np.sum(testing_norms, axis=0)))
